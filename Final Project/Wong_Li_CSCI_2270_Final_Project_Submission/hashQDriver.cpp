...
int main()
{
    ...
    float HQinsert[400] = {-1};
    float HQsearch[400] = {-1};
    int rngIndex[100] = {-1};
...
//  ~~~~~INSERT AND TIMING~~~~~
    ...
    ofstream ofile(fileName + "_HashQuadInsertTimes.csv");        
    for(int i = 0; i < 400; i++)
    {
        ofile << HQinsert[i] << "," << endl;
    }
    ofile.close();

    ofstream ofile2(fileName + "_HashQuadInsertCollisions.csv");        
    for(int i = 0; i < 4; i++)
    {
...
//  ~~~~~SEARCH AND TIMING~~~~~~
    ...
    ofstream ofile4(fileName + "_HashQuadSearchTimes.csv");
    for(int i = 0; i < 400; i++)
    {
        ofile4 << HQsearch[i] << "," << endl;
    }
    ofile4.close();

    ofstream ofile3(fileName + "_HashQuadSearchCollisions.csv");        
    for(int i = 0; i < 4; i++)
    {
